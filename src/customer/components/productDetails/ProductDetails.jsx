        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xe font-semibold text-gray-900">
                Universaloutfit
              </h1>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className="font-semibold">MAD 199</p>
                <p className="opacity-50 line-through">MAD 182</p>
                <p className="text-green-500 font-semibold">10% Off</p>
              </div>
              ...
              <p className="opacity-50 text-sm">4768 Rating</p>
              <p className="ml-3 text-sm font-medium text-indigo-500
              hover:text-indigo-500">3878 Reviews</p>
              </div>
